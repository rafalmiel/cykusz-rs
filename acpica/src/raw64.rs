...
pub const ACPI_SIG_AGDI: &[u8; 5usize] = b"AGDI\0";
...
pub const ACPI_SIG_TDEL: &[u8; 5usize] = b"TDEL\0";
...
pub const ACPI_CA_VERSION: u32 = 539038231;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_data_table_space_context {
    pub Pointer: *mut ::core::ffi::c_void,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[doc = ""]
#[doc = " Conforms to \"ACPI for Arm Components 1.1, Platform Design Document\""]
#[doc = " ARM DEN0093 v1.1"]
#[doc = ""]
#[repr(C, packed)]
#[derive(Copy, Clone)]
...
#[doc = " NHLT - Non HD Audio Link Table"]
#[doc = ""]
#[doc = " Conforms to: Intel Smart Sound Technology NHLT Specification"]
#[doc = " Version 0.8.1, January 2020."]
#[doc = ""]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_table_nhlt {
    pub Header: ACPI_TABLE_HEADER,
    pub EndpointCount: UINT8,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_table_nhlt_endpoint_count {
    pub EndpointCount: UINT8,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_endpoint {
    pub DescriptorLength: UINT32,
    pub LinkType: UINT8,
...
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_config {
...
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_config_a {
    pub CapabilitiesSize: UINT32,
    pub VirtualSlot: UINT8,
    pub ConfigType: UINT8,
    pub ArrayType: UINT8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_config_d {
    pub VirtualSlot: UINT8,
    pub ConfigType: UINT8,
    pub ArrayType: UINT8,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_config_b {
    pub CapabilitiesSize: UINT32,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_config_c {
    pub CapabilitiesSize: UINT32,
    pub VirtualSlot: UINT8,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_render_device_specific_config {
    pub CapabilitiesSize: UINT32,
    pub VirtualSlot: UINT8,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_wave_extensible {
    ...
    pub SubFormatGuid: [UINT8; 16usize],
}
pub type ACPI_NHLT_WAVE_EXTENSIBLE = acpi_nhlt_wave_extensible;
#[repr(C, packed)]
pub struct acpi_nhlt_format_config {
    pub Format: ACPI_NHLT_WAVE_EXTENSIBLE,
    pub CapabilitySize: UINT32,
    pub Capabilities: __IncompleteArrayField<UINT8>,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_device_specific_hdr {
    pub VirtualSlot: UINT8,
    pub ConfigType: UINT8,
}
pub type ACPI_NHLT_DEVICE_SPECIFIC_HDR = acpi_nhlt_device_specific_hdr;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_mic_device_specific_config {
    pub DeviceConfig: ACPI_NHLT_DEVICE_SPECIFIC_HDR,
    pub ArrayTypeExt: UINT8,
}
pub type ACPI_NHLT_MIC_DEVICE_SPECIFIC_CONFIG = acpi_nhlt_mic_device_specific_config;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_vendor_mic_count {
    pub MicrophoneCount: UINT8,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
...
#[repr(C)]
pub struct acpi_nhlt_vendor_mic_device_specific_config {
    pub MicArrayDeviceConfig: ACPI_NHLT_MIC_DEVICE_SPECIFIC_CONFIG,
    pub NumberOfMicrophones: UINT8,
    pub MicConfig: __IncompleteArrayField<ACPI_NHLT_VENDOR_MIC_CONFIG>,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_mic_snr_sensitivity_extension {
    pub SNR: UINT32,
    pub Sensitivity: UINT32,
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_render_feedback_device_specific_config {
    pub FeedbackVirtualSlot: UINT8,
    pub FeedbackChannels: UINT16,
    pub FeedbackValidBitsPerSample: UINT16,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_linux_specific_count {
    pub StructureCount: UINT8,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_linux_specific_data {
    pub DeviceId: [UINT8; 16usize],
    pub DeviceInstanceId: UINT8,
    pub DevicePortId: UINT8,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_linux_specific_data_b {
    pub SpecificData: [UINT8; 18usize],
}
#[repr(C, packed)]
#[derive(Copy, Clone)]
pub struct acpi_nhlt_table_terminator {
    pub TerminatorValue: UINT32,
    pub TerminatorSignature: UINT32,
}
