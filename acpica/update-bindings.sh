...
bindgen  --use-core -o src/raw64.rs --whitelist-type acpi.* --whitelist-var ACPI.*  --whitelist-function Acpi.* --blacklist-function AcpiOs.*  --no-layout-tests acpica/source/include/acpi.h  -- -DCYKUSZ -DACPI_LIBRARY
