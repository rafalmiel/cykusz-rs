...
PROGS="test testcpp hello stack nyancat ttytest fork forktest poweroff stat fbdoom doom1.wad open_sleep"
RUST_PROGS="init shell mount umount unixsocket-server unixsocket-client"
